  ...
  Future<void> signInWithGoogleApiCalling() async {
    ...
    if (userData.value != null) {
      ...
      if (userData.value?.customer?.isRegister == "1") {
        ...
        await MyCommonMethods.setString(key: ApiKeyConstant.stateId, value: userData.value?.customer?.stateId.toString()??'');

        await MyCommonMethods.setString(key: ApiKeyConstant.cityId, value: userData.value?.customer?.countryId.toString()??'');
