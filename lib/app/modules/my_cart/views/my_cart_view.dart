...
class MyCartView extends GetView<MyCartController> {
  ...
  Widget applyCouponButtonView({required BuildContext context, required String text}) =>
      Obx(() {
        controller.count.value;
        return GradientText(
          text,
  ...
  Widget uncheckedItemHowManyPercentOffTextView({required int index, required String value}) =>
      Text(
        " ($value% Off)",
        style: Theme
            .of(Get.context!)
