...
class MyCartView extends GetView<MyCartController> {
            ...
            child: Scaffold(
                ...
                body: Obx(() {
                    ...
                    if (CommonMethods.isConnect.value) {
                      if (controller.getCartDetailsModel != null && controller.responseCode == 200) {
                        if (controller.checkedCarItemList.isNotEmpty || controller.unCheckedCartItemList.isNotEmpty) {
                                ...
                                Column(
                                  children: [
                                    ...
                                    if (controller.unCheckedCartItemList.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.only(right: 16.px, left: 16.px, top: 16.px),
                                    ...
                                    if (!controller.wantBackButton)
                                      Center(
                                        child: continueShoppingButtonView(context: context),
                                      ),
                                      SizedBox(
                                      height: 8.h
                                    ),
  ...
  Widget addAddressButtonView({required BuildContext context}) => CommonWidgets.myOutlinedButton(
          radius: 5.px,
  ...
  Widget changeAddressButtonView({required BuildContext context}) => CommonWidgets.myOutlinedButton(
        height: 32.px,
        //width: 20.w,
        wantFixedSize: false,
  ...
  Widget readyToCheckOutItemPriceTextView({required int index, required String value}) => GradientText(
        '$curr$value',
        style: Theme
            .of(Get.context!)
            .textTheme
  ...
  Widget readyToCheckOutItemOriginalPriceTextView({required int index, required String value}) => Text(
        "$curr$value",
        maxLines: 1,
        overflow: TextOverflow.ellipsis,
        style: Theme
  ...
  Widget readyToCheckOutItemHowManyPercentOffTextView({required int index, required String value}) => Text(
        " ($value% Off)",
        style: Theme
            .of(Get.context!)
            .textTheme
  ...
  Widget elevatedButtonForItemList({required VoidCallback onPressed, required Widget child, double? height}) => Container(
        height: height ?? 3.5.h,
        width: 32.px,
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(2.px),
                  ...
                  Align(
                    ...
                    child: SizedBox(
                      ...
                      child: MyDropdownMenu(
                        ...
                        dropdownMenuEntries: controller.cartItem!.varientList!.map((VarientList value) {
                        ...
                        onSelected: (value) async {
                          ...
                          if (int.parse(value!.availability!) < v) {
                            controller.checkedListItemQuantity[index] = int.parse(value.availability!);
                          }
                          ...
                          if (response != null) {
                            ...
                            controller.checkedListItemAvailability[index] = value.availability;
                          }
  ...
  Widget readyToCheckOutItemSubtractButtonView({required int index}) => SizedBox(
        height: 28.px,
        width: 32.px,
        child: InkWell(
          onTap: () =>
  ...
  Widget readyToCheckOutItemDecreaseQuantityOfItemView({required int index}) => Icon(
        Icons.keyboard_arrow_down_outlined,
        size: 16.px,
        color: controller.checkedListItemQuantity[index] != 1
            ? Theme.of(Get.context!).colorScheme.onSurface : Theme.of(Get.context!).colorScheme.onSurface.withOpacity(0.2),
      );
  ...
  Widget readyToCheckOutItemIncreaseQuantityOfItemView({required int index}) => Icon(
  ...
  Widget readyToCheckOutItemDeleteItemFromCartView({required int index}) => InkWell(
          onTap: () =>
  ...
  Widget applyCouponButtonView({required BuildContext context, required String text}) => Obx(() {
        controller.count.value;
        return GradientText(
          text,
          style: Theme
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              priceDetailsTextView(
                  text: 'Rs. ${controller.sellPrice.value - controller.discountPrice.value + controller.deliveryPrice.value}'),
            ],
          ),
          SizedBox(height: 10.px),
          savingMoneyText(),
  ...
  Widget proceedToPaymentButton({required BuildContext context}) => CommonWidgets.myElevatedButton(
          text: Text('Proceed To Payment',
              style: Theme.of(Get.context!).textTheme.subtitle1?.copyWith(color: MyColorsLight().secondary)),
          onPressed: () =>
              controller.clickOnProceedToPaymentButton(context: context,totalAmount:'${controller.sellPrice.value - controller.discountPrice.value + controller.deliveryPrice.value}'),
          height: 42.px,
  ...
  Widget uncheckedItemImageView({required int index, required String value}) => ClipRRect(
        borderRadius: BorderRadius.circular(5.px),
        child: Image.network(
  ...
  Widget uncheckedItemDescriptionTextView({required int index, required String value}) => Row(
        children: [
          Expanded(
            child: Text(
              value,
  ...
  Widget uncheckedItemPriceTextView({required int index, required String value}) =>
      GradientText(
        '$curr$value',
        style: Theme
            .of(Get.context!)
  ...
  Widget uncheckedItemOriginalPriceTextView({required int index, required String value}) =>
      Text(
        "$curr$value",
        maxLines: 1,
        overflow: TextOverflow.ellipsis,
  ...
  Widget uncheckedItemHowManyPercentOffTextView({required int index, required String value}) => Text(
        " ($value% Off)",
        style: Theme
            .of(Get.context!)
            .textTheme
