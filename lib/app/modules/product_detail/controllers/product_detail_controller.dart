...
*/
  ...
  clickOnAddToOutfitButton() async {
    if (productDetail != null &&
        productDetail?.categoryTypeId != null &&
        productDetail!.categoryTypeId!.isNotEmpty) {
      bodyParams = {
        //ApiKeyConstant.productId: productId.toString(),
        ApiKeyConstant.categoryTypeId:
  ...
  clickOnViewOutfitButton() async {
    ...
    await Get.toNamed(Routes.OUTFIT_ROOM, arguments: 0.0);
    await onInit();*/
