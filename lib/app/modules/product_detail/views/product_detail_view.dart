                  ...
                  if (CommonMethods.isConnect.value) {
                    if (controller.getProductDetailsModel != null &&
                      ...
                      if ((controller.productDetail != null &&
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          (controller.inventoryArr!.availability != null &&
                                              controller.inventoryArr!.availability!.isNotEmpty &&
                                              controller.inventoryArr!.availability != '0')
                                              ? Column(
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  if (controller.productDetail!.vendorType != null &&
                                                      controller.productDetail!.vendorType!.isNotEmpty)
                                                    Expanded(
                                                      child:
                                                      buyNowOrCustomizeButton(
                                                          buttonText: controller.productDetail!.vendorType.toString() == 'Tailor' ? 'Customize' : controller.isViewToOutfitRoomVisible.value ? 'View Outfit' : 'Add to Outfit'),
                                                    ),
                                                ],
                                              ),
                                              SizedBox(height: 1.h),
                                              buyNowOrCustomizeButton(buttonText: "Buy Now"),
                                            ],
                                          )
                                              : Row(
                                            children: [
                                    ...
                                    (controller.getProductApiModel != null)
                                      ...
                                      children: [
                                        ...
                                        : controller.getProductDetailRecentApiValue.value
                        ...
                        if ((controller.productDetail == null &&
                            controller.initialIndexOfInventoryArray.value == -1) && (controller.listOfInventoryArr.isEmpty)) {
...
*/
  ...
  Widget reviewsAndRatings({required BuildContext context}) {
    return Column(
      ...
      children: [
        ...
        // if ((controller.reviewList.isNotEmpty) && controller.reviewList.length > 1)
          SizedBox(height: 4.px),
        Row(
          children: [
            ((controller.productDetail?.totalRating != null && controller.productDetail!.totalRating!.isNotEmpty) && controller.productDetail?.totalRating != "0.0")
              ?Text(
            ...
            // if (controller.productDetail?.totalRating != null && controller.productDetail?.totalRating != "0.0")
              SizedBox(width: 10.px),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  if (controller.productDetail?.totalReview != null && controller.productDetail?.totalReview != "0")
  ...
  Widget bestReviewView() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        if ((controller.bestReview?.rating != null && controller.bestReview!.rating!.isNotEmpty) &&
            (controller.bestReview?.rating != "0" && controller.bestReview?.rating != "0.0"))
          Row(
            children: [
              RatingBar.builder(
