...
class NavigatorBottomBarController extends GetxController with GetSingleTickerProviderStateMixin{
  ...
  void onInit() {
    super.onInit();
    bottomNavigationController = TabController(length: 5, vsync: this);
  }
