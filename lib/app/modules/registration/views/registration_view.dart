                                ...
                                Expanded(
                                  child: ListView(
                                    ...
                                    children: [
                                      ...
                                      Center(child: CommonWidgets.zeroCartImage()),
                                      SizedBox(
                                      ...
                                      if(controller.citiesList != null && controller.citiesList!.isNotEmpty)
                                      SizedBox(height: 2.h),
                                      if(controller.citiesList != null && controller.citiesList!.isNotEmpty)
                                      ...
                                      SizedBox(height: 2.h),
                                      if (controller.fashionCategoryList != null && controller.fashionCategoryList!.isNotEmpty)
                                      Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: MultiSelectBottomSheetField(
                                                ...
                                                items: controller.fashionCategoryList!.map(
                                                      (e) => MultiSelectItem(e, e.name.toString(),),
                                                    ).toList(),
                                                onConfirm: (value) {
                                                  controller.selectedFashionCategory.value = value;
                                                ...
                                                searchTextStyle: Theme.of(
                                                        Get.context!).textTheme.subtitle2
                                                    ?.copyWith(
                                                      fontSize: 16.px,
                                                      fontWeight: FontWeight.w800,
                                                      color: MyColorsLight().onText,
                                            ...
                                            Obx(() {
                                              return controller.count.value >= 0
                                                ...
                                                textStyle: Theme.of(Get.context!).textTheme.subtitle2?.copyWith(fontSize: 12.px,color: Theme.of(context).colorScheme.secondary),
                                                      list: controller.selectedFashionCategory.value,
                                                    )
                                                  : const SizedBox();
                                            }),
                                            SizedBox(height: 1.h),
                                      ...
                                      if (controller.brandList != null && controller.brandList!.isNotEmpty)
                                      Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            titleTextView(
                                              ...
                                              child: MultiSelectBottomSheetField(
                                                ...
                                                onConfirm: (value) {
                                                  ...
                                                  for (var element in controller.selectedBrands) {
                                                    controller.idBrand.add(element.brandId);
                                                  }
                                                },
                                                title: Text(
                                            ...
                                            my(
                                              ...
                                              items: controller.selectedBrands.value.map((e) => MultiSelectItem(e, e.brandName.toString())).toList(),
                                              scrollController: ScrollController(),
                                              scroll: true,
                                              scrollBar: HorizontalScrollBar(isAlwaysShown: true),
                                              decoration: BoxDecoration(
                                              ...
                                              textStyle: Theme.of(Get.context!).textTheme.subtitle2?.copyWith(fontSize: 12.px,color: Theme.of(context).colorScheme.secondary),
                                              // ignore: invalid_use_of_protected_member
                                              list: controller.selectedBrands.value,
                                            ),
                                            SizedBox(height: 1.h),
                                          ],
                                        ),
