          ...
          child: Scaffold(
            ...
            appBar: controller.searchPageValue == 'searchPage'
                ...
                : const MyCustomContainer().myAppBar(
                    ...
                    backIconOnPressed: () =>
                        controller.clickOnBackButton(context: context),
                    text: (controller.categoryName != null && controller.categoryName!.isNotEmpty)
                        ? controller.categoryName
                        : 'Result',
                    buttonText: /*controller.isChatOption == '1'
                        ? 'Upload Prescription'
                        :*/'Filters',
                    isChatOption: /*controller.isChatOption == '1' ? true :*/false),
            body: Obx(
              () {
                controller.count.value;
                if (CommonMethods.isConnect.value) {
                  if ((controller.getProductListApiModel != null || controller.searchProductModel != null) && controller.responseCode == 200) {
                    ...
                    text: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 4.px),
                          Text(controller.filterDataList[index], style: Theme.of(Get.context!).textTheme.headline3),
                        ],
                      ),
                    ),
                    onPressed: () => controller.clickOnFilterOptionListButton(index: index),
                  ),
                  SizedBox(width: 2.w)
                ],
              );
