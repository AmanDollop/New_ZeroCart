                ...
                child: Obx(() {
                  if (CommonMethods.isConnect.value) {
                    if (controller.responseCodeState == 200 && controller.responseCodeCity == 200 && controller.responseCodeBrandList == 200 && controller.responseCodeCategoryList == 200) {
                                                      ...
                                                      children: [
                                                        Obx(() {
                                                          return controller.count.value >= 0
                                                              ? myCheckBox(
                                                                  checkBoxValue: controller.checkTypeOfProductsValue.value == index.toString()
                                                                          ? true
                                                                          : false,
                                                ...
                                                return controller.count.value >= 0
                                                    ? Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: MultiSelectBottomSheetField(
                                                              ...
                                                              buttonIcon: Icon(
                                                                  ...
                                                                  size: 22.px),
                                                              selectedItemsTextStyle: Theme.of(Get.context!).textTheme.subtitle2?.copyWith(
                                                                      fontSize: 16.px,
                                                                      fontWeight: FontWeight.w800,
                                                              ...
                                                              searchIcon: Icon(
                                                                  Icons.search,
                                                                  color: MyColorsLight().onText),
                                                              searchTextStyle: Theme.of(Get.context!).textTheme.subtitle2?.copyWith(
                                                                      fontSize: 16.px,
                                                                      fontWeight: FontWeight.w800,
                                                                      color: MyColorsLight().onText),
                                                              ...
                                                              items: controller.fashionCategoryList.map((e) => MultiSelectItem(e, e.name.toString()),
                                                                  ).toList(),
                                                              onConfirm: (value) {
                                                          ...
                                                          SizedBox(height: 1.h),
                                                          my(items: controller.selectFashionCategoryList.map((e) => MultiSelectItem(e, e.name.toString())).toList(),
                                                            ...
                                                            chipColor: Theme.of(context).brightness==Brightness.dark?MyColorsLight().secondary:MyColorsDark().primaryColor.withOpacity(.8),
                                                            textStyle: Theme.of(Get.context!).textTheme.subtitle2?.copyWith(fontSize: 12.px,color: Theme.of(context).colorScheme.secondary),
                                            ...
                                            Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: MultiSelectBottomSheetField(
                                                      initialValue: controller.selectBrandList.toList(),
                                                      isDismissible: false,
                                                      title: Text(
                                                        'Select Fashion Brands',
                                                        style: Theme.of(Get.context!).textTheme.subtitle2?.copyWith(
                                                      ...
                                                      items: controller.brandList
                                                          .map((e) => MultiSelectItem(e, e.brandName.toString())).toList(),
                                                      onConfirm: (value) {
                      ...
                      if (controller.responseCodeState == 0 || controller.responseCodeCity == 0 || controller.responseCodeBrandList == 0 || controller.responseCodeCategoryList == 0) {
...
*/
  ...
  Widget myCheckBox({required bool checkBoxValue, required ValueChanged<bool?> onChanged}) =>
      Checkbox(
  ...
  Widget my({Function(Value)? onTap,
      Color? chipColor,
  ...
  Widget _buildItem(
    ...
    return Container(
      ...
      child: ChoiceChip(
        ...
        selectedColor: colorator ?? chipColor ?? Theme.of(Get.context!).primaryColor.withOpacity(0.33),
        onSelected: (_) {
