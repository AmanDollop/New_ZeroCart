...
class CategoryController extends CommonMethods {
  ...
  Future<void> clickOnCategory(
    ...
    afterClickOnCategoryWorking(
      ...
      categoryId: listOfCategories[index].fashionCategoryId.toString(),
      categoryName: listOfCategories[index].name.toString(),
      type: listOfCategories[index].type.toString(),
    );
  }
    ...
    if (response != null) {
      if (await CommonMethods.checkResponse(response: response)) {
        ...
        if (getCategories != null) {
          ...
          if(getCategories!.tailor!=null)
            {
              tailor = getCategories!.tailor!;
            }
        }
      }
    }
  ...
  clickOnTailorCategory({required BuildContext context}) {
    Get.toNamed(Routes.CATEGORIE_PRODUCT, parameters: {
      'categoryName': 'Tailor',
      'categoryId': '0',
      'type': 'Tailor',
