...
class MyOrderDetailsView extends GetView<MyOrderDetailsController> {
            ...
            if (CommonMethods.isConnect.value) {
              ...
              if (controller.myOrderDetailsModel != null &&
                ...
                if (controller.productDetailsList.isNotEmpty) {
                  if (controller.orderListObject?.createdDate != null && controller.orderListObject!.createdDate!.isNotEmpty) {
                    controller.dateTime = DateTime.parse(controller.orderListObject!.createdDate!);
                  }
                        ...
                        children: [
                          AspectRatio(
                            ...
                            child: Container(
                              ...
                              child: (controller.productDetailsList[0].thumbnailImage != null &&
                                      controller.productDetailsList[0].thumbnailImage!.isNotEmpty)
                                  ? Image.network(
                          ...
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: Zconstant.margin, vertical: 2.h),
                            child: Column(
                                ...
                                Padding(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      trackButtonView(width:controller.orderListObject?.itemOrderStatus == 'Shipped'?88.w:43.w),
                                    ],
                                  ),
                                ),
                                if(controller.orderListObject?.itemOrderStatus != 'Canceled' && controller.orderListObject?.itemOrderStatus != 'Shipped' && controller.orderListObject?.itemOrderStatus != 'Pending')
                                if(controller.productDetailsList[0].isRated == '0')
                                rateButton(),
                                SizedBox(height: 20.px),
                              ],
                            ),
  ...
  Widget trackButtonView({required double width}) => CommonWidgets.myOutlinedButton(
      text: trackTextView(),
      onPressed: () => controller.clickOnTrackButton(orderPlaceDate: '${getDayOfMonthSuffix(controller.dateTime!.day)} ${DateFormat.MMMM().format(controller.dateTime!)} ${controller.dateTime?.year}',orderNo: controller.orderListObject?.ordNo.toString()??''),
      margin: EdgeInsets.zero,
      height: 40.px,
      width: width,
      radius: 5.px);
