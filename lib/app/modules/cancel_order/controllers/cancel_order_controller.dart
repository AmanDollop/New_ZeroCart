...
class CancelOrderController extends CommonMethods {
  ...
  Future<void> cancelOrderApiCalling() async {
    bodyParamsForCancelOrderApi = {
      ApiKeyConstant.orderId:     myOrderDetailPage == 'myOrderDetailPage' ? orderListObjectDetail.ordId.toString() :     orderListObject.ordId.toString(),
      ApiKeyConstant.orderItemId: myOrderDetailPage == 'myOrderDetailPage' ? orderListObjectDetail.ordItmId.toString() : orderListObject.ordItmId.toString() ,
      ApiKeyConstant.itemPrice:   myOrderDetailPage == 'myOrderDetailPage' ? orderListObjectDetail.productPrice.toString() : price.toString() ,
      ApiKeyConstant.orderItemUuid:myOrderDetailPage == 'myOrderDetailPage' ? orderListObjectDetail.itemUuid.toString() : orderListObject.itemUuid.toString()  ,
    ...
    if (response != null) {
      if(myOrderDetailPage == 'myOrderDetailPage') {
        Get.offNamed(Routes.CONFIRM_CANCEL,arguments: ['MyOrderDetailPage']);
      }else{
        Get.offNamed(Routes.CONFIRM_CANCEL,arguments: ['MyOrderPage']);
      }
    } else {
