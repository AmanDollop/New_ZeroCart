...
class CommonWidgets {
  ...
  */
  ...
  static Widget commonNoDataFoundImage({required RefreshCallback onRefresh,String? title}) {
    return RefreshIndicator(
      onRefresh: () async {
        await Future.delayed(const Duration(seconds: 1));
      },
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  commonTitleForError(title: title??Zconstant.textNoDataTitle),
  ...
  static AssetImage defaultProfilePicture() =>Theme.of(Get.context!).brightness == Brightness.dark
      ...
      : const AssetImage("assets/profile_pic_black.png");
