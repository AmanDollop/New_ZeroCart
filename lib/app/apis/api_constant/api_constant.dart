class ApiConstUri {
 ...
 /* static const  baseUrl ='http://zerocart.in/';
  ...
  static const endPointGetProductBasedOnPreferenceApi = "${baseUrl}getProductBasedOnPreferenceApi";

  static const endPointGetProductBasedOnHistoryApi = "${baseUrl}getProductBasedOnHistoryApi";
  ...
  static const endPointAddToCollectionApi = '${baseUrl}addToCollectionApi';

  static const endPointGetOutfitRoomListApi = '${baseUrl}getOutfitRoomListApi';

  static const endPointGetCollectionListApi = '/getCollectionListApi';
  // static const endPointGetCollectionListApi = '${baseUrl}getCollectionListApi';

  static const endPointMoveOutfitToCartApi = '${baseUrl}moveOutfitToCartApi';

  static const endPointGetOutfitListApi = '${baseUrl}getOutfitListApi';

  static const endPointAddOutfitToCartApi = '${baseUrl}addOutfitToCartApi';

  static const endPointAddToOutfitsApi = '${baseUrl}addToOutfitsApi';

  static const endPointRemoveCollectionItemApi = '${baseUrl}removeCollectionItemApi';
  ...
  static const endPointGetSubCategoriesApi = '${baseUrl}subCategoriesApi';
}
...
class ApiKeyConstant {
  ...
  static const isSlider = "isSlider";
  ...
  static const categoryTypeId = "categoryTypeId";
  ...
  static var footwearInventoryId = "footwearInventoryId";
  static var accessoriesInventoryIds = "accessoriesInventoryIds";
  static var collectionUuid = "collectionUuid";
}
