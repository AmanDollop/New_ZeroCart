...
class CommonApis {
  ...
  static Future<http.Response?> addToCollectionApi({
    required Map<String, dynamic> bodyParams,
  }) async {
    Map<String, String> authorization = {};
    String? token = await MyCommonMethods.getString(key: ApiKeyConstant.token);
    authorization = {"Authorization": token!};
    http.Response? response = await MyHttp.postMethod(
      url: ApiConstUri.endPointAddToCollectionApi,
      bodyParams: bodyParams,
      token: authorization,
      context: Get.context!,
    );
  ...
  static Future<http.Response?> addToOutfitsApi({
    required Map<String, dynamic> bodyParams,
  }) async {
    Map<String, String> authorization = {};
    String? token = await MyCommonMethods.getString(key: ApiKeyConstant.token);
    authorization = {"Authorization": token!};
    http.Response? response = await MyHttp.postMethod(
      url: ApiConstUri.endPointAddToOutfitsApi,
      bodyParams: bodyParams,
      token: authorization,
      context: Get.context!,
    );
  ...
  static Future<http.Response?> removeCollectionItemApi({
    required Map<String, dynamic> bodyParams,
  }) async {
    Map<String, String> authorization = {};
    String? token = await MyCommonMethods.getString(key: ApiKeyConstant.token);
    authorization = {"Authorization": token!};
    http.Response? response = await MyHttp.postMethod(
      url: ApiConstUri.endPointRemoveCollectionItemApi,
      bodyParams: bodyParams,
      token: authorization,
      context: Get.context!,
    );
