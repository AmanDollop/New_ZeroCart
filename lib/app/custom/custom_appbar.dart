...
class MyCustomContainer extends GetView<HomeController> {
  ...
  Widget myStackAppBarSizeBox({required Widget child, bool? wantProfileMenuDash = false}) {
    return Column(
      children: [
        ...
        ?*/ Container(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () => controller.clickOnSearchField(isSearch: isSearch),
                  ...
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          flex: 2,
                          child: Icon(Icons.search, color: Theme.of(Get.context!).colorScheme.onSecondary),
                        ),
                        Expanded(
                          flex: 7,
                          child: Text(
